      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {activeTab === 'signup' && (
              <div>
                ...
                <div className="flex gap-2">
                  <button type="button" onClick={detectLocation} className="px-4 py-3 rounded-lg border border-neutral bg-neutral-light text-neutral-darker hover:bg-neutral">
                    Detect
                  </button>
                  <input
                    type="text"
            ...
            {error && (
              <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg text-sm">
                {error}
              </motion.div>
            )}
